...
echo.
echo REM Run the broadcast client
echo start "GameLift-IVS-Broadcaster" "%%PACKAGE_ROOT%%bin\gamelift-streams-ivs-broadcast-sidecar-sample.exe" %%*
echo.
...
echo set GST_DEBUG=0
echo.
echo REM Start the broadcaster in background ^(minimized^)
...
echo start /MIN "GameLift-IVS-Broadcaster" "%%PACKAGE_ROOT%%bin\gamelift-streams-ivs-broadcast-sidecar-sample.exe" %%*
echo.
